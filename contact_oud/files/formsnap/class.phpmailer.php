<?php
// Timestamp: [[ 2012-09-13 08:17:03 +0000 by Mike Yrabedra (mikeyrab) ]]
// Edited Line 769 on 09-13-2012 08:17:01 am
/*~ class.phpmailer.php
.---------------------------------------------------------------------------.
  ...
  protected function MailSend($header, $body) {
    ...
    if ($this->Sender != '' and !ini_get('safe_mode')) {
      ...
      if ($this->SingleTo === true && count($toArr) > 1) {
        ...
        //$rt = @mail($to, $this->EncodeHeader($this->SecureHeader($this->Subject)), $body, $header, $params);
        $rt = @mail($to, $this->EncodeHeader($this->SecureHeader($this->Subject)), $body, $header); // $params added in 5.2.1, breaks things -MY
        // implement call back function if it exists
        $isSent = ($rt == 1) ? 1 : 0;
        $this->doCallback($isSent, $to, $this->cc, $this->bcc, $this->Subject, $body);
      }
