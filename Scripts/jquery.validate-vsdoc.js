...
$.extend($.validator, {
	...
	messages: {
		...
		digits: "Alleen getallen zijn toegestaan.",
		...
		minlength: $.validator.format("Geef tenminste {0} karakters op."),
		rangelength: $.validator.format("Geef een waarde van minimaal {0} en maximaal {1} karakters lang."),
		range: $.validator.format("Geef een getal tussen {0} en {1} op."),
		max: $.validator.format("Vul een getal lager dan of gelijk aan {0} in."),
		min: $.validator.format("Vul een getal groter dan of gelijk aan {0} in.")
        /*
